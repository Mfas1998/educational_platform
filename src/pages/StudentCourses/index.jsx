    ...
    <div className=" bg-violet-50 p-2">
      <div className=" flex flex-col gap-4 justify-center p-8 m-10 rounded-2xl  bg-violet-700 ">
        <div className=" items-center justify-center font-bold text-textColorprimary text-2xl  ">
            <Reveal>
          <p className="shadow-[0_0_7px_rgba(0,0,0,5)] border rounded-2xl p-2">الكرسات المشترك فيهــا</p></Reveal>
        </div>
        ...
        <hr className="my-10" />
        <div className=" items-center justify-center font-bold text-textColorprimary text-2xl  ">
            <Reveal><p className="shadow-[0_0_7px_rgba(0,0,0,5)] border rounded-2xl p-2">الكرسات المفضلة</p></Reveal>
        </div>
