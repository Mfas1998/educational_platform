...
const Footer = () => {
    return(
        ...
        <div className="w-full">   
            <div className='grid  grid-cols-4 items-center place-items-center pb-48 '>
            ...
            <div className='bg-primary  px-20 pt-16 pb-4 text-textColor -mt-56 w-full'>
              ...
              <div className=' grid  justify-between pt-6 text-sm'><div className=' text-start w-auto'><span>Copyright 2023 | All Rights Reserved</span></div><div className='flex justify-between w-40 pr-16 text-start mr-96'><CiFacebook /><CiTwitter /><AiOutlineInstagram /><BsVoicemail /></div></div>
            </div>
